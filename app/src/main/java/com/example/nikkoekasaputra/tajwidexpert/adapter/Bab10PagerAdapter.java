...
import com.example.nikkoekasaputra.tajwidexpert.fragment.bab10.*;

public class Bab10PagerAdapter extends FragmentPagerAdapter {
    //nama tab nya
    String[] title = new String[]{
            "Tab 1", "Tab 2", "Tab 3"
    };

    public Bab10PagerAdapter(FragmentManager fm) {
        super(fm);
    }
