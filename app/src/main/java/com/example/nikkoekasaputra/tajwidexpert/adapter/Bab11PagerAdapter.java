...
import com.example.nikkoekasaputra.tajwidexpert.fragment.bab11.*;

public class Bab11PagerAdapter extends FragmentPagerAdapter {
    //nama tab nya
    String[] title = new String[]{
            "Tab 1", "Tab 2", "Tab 3"
    };

    public Bab11PagerAdapter(FragmentManager fm) {
        super(fm);
    }
