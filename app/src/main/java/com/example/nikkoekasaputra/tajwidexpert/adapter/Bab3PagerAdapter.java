...
import com.example.nikkoekasaputra.tajwidexpert.fragment.bab3.*;

public class Bab3PagerAdapter extends FragmentPagerAdapter {
    //nama tab nya
    String[] title = new String[]{
            "Tab 1", "Tab 2", "Tab 3"
    };

    public Bab3PagerAdapter(FragmentManager fm) {
        super(fm);
    }
