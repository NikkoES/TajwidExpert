...
import com.example.nikkoekasaputra.tajwidexpert.fragment.bab5.*;

public class Bab5PagerAdapter extends FragmentPagerAdapter {
    //nama tab nya
    String[] title = new String[]{
            "Tab 1", "Tab 2", "Tab 3"
    };

    public Bab5PagerAdapter(FragmentManager fm) {
        super(fm);
    }
