...
import com.example.nikkoekasaputra.tajwidexpert.fragment.bab8.*;

public class Bab8PagerAdapter extends FragmentPagerAdapter {
    //nama tab nya
    String[] title = new String[]{
            "Tab 1", "Tab 2", "Tab 3"
    };

    public Bab8PagerAdapter(FragmentManager fm) {
        super(fm);
    }
