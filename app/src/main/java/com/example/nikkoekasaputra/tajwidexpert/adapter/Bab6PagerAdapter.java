...
import com.example.nikkoekasaputra.tajwidexpert.fragment.bab6.*;

public class Bab6PagerAdapter extends FragmentPagerAdapter {
    //nama tab nya
    String[] title = new String[]{
            "Tab 1", "Tab 2", "Tab 3"
    };

    public Bab6PagerAdapter(FragmentManager fm) {
        super(fm);
    }
