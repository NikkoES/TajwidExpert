...
import com.example.nikkoekasaputra.tajwidexpert.fragment.bab12.*;

public class Bab12PagerAdapter extends FragmentPagerAdapter {
    //nama tab nya
    String[] title = new String[]{
            "Tab 1", "Tab 2", "Tab 3"
    };

    public Bab12PagerAdapter(FragmentManager fm) {
        super(fm);
    }
