...
import com.example.nikkoekasaputra.tajwidexpert.fragment.bab9.*;

public class Bab9PagerAdapter extends FragmentPagerAdapter {
    //nama tab nya
    String[] title = new String[]{
            "Tab 1", "Tab 2", "Tab 3"
    };

    public Bab9PagerAdapter(FragmentManager fm) {
        super(fm);
    }
