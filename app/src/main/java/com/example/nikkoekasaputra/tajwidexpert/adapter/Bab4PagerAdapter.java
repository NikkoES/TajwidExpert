...
import com.example.nikkoekasaputra.tajwidexpert.fragment.bab4.*;

public class Bab4PagerAdapter extends FragmentPagerAdapter {
    //nama tab nya
    String[] title = new String[]{
            "Tab 1", "Tab 2", "Tab 3"
    };

    public Bab4PagerAdapter(FragmentManager fm) {
        super(fm);
    }
